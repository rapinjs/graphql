...
exports.Mutation = (path) => {
    return (target, propertyKey, descriptor) => {
        load_1.setMutation(path ? path : propertyKey, (root, args) => __awaiter(void 0, void 0, void 0, function* () {
            const actionPath = helpers_1.getPath(target) + '/' + propertyKey;
            helpers_1.getRegistry().get('request').post = Object.assign(Object.assign({}, args), helpers_1.getRegistry().get('request').post);
